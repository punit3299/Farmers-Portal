...
<nav class="navbar navbar-expand-lg navbar-light bg-dark mx-lg-5 mx-0">
  ...
  <div class="col-sm" align="center"><a class="navbar-brand text-white" href="fertpostad.php" onclick="showform();">Post Advertise</a></div>
  <div class="col-sm" align="center"><a class="navbar-brand text-white" href="fertstatus.php">Payment Status</a></div>
  <div class="col-sm" align="center"><a class="navbar-brand text-white" href="fertpostcomplain.php">Complain Section</a></div>
...
<form action="fertcomplain.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <input class="form-control" type="text" name="pname" required placeholder="Enter Name"/>
                <span class="Error"></span>
            </div>
            <div class="form-group">
